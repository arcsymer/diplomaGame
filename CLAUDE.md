...
## Жёсткие ограничения
- **Нулевой бюджет** (`Docs-Vault/Prompts/zero-budget-constraint.md`, ADR-009): никаких покупок, подписок, платных API, триалов с картой. Только FOSS, локальная генерация, CC0/CC-BY-ассеты.
