...
|---|---|---|---|---|
| M0 | Инфраструктура | Репо, LFS, CI, Project Forge, сцена-песочница | **В работе** | 60% |
| M1 | Режимы / Камеры | Cinemachine 3.1, стейт-машина, 2 Action Map | Не начат | 0% |
| M2 | RTS-управление | Выделение, приказы, контрол-группы | Не начат | 0% |
| M3 | TPS-герой | WASD+мышь, стрельба, способности | Не начат | 0% |
| M4 | Бой и ИИ | HP/урон, авто-цели, FSM-поведение, SO-статы | Не начат | 0% |
| M5 | Экономика / Постройки | Авто-добыча, очередь производства, здания | Не начат | 0% |
...
| Дата | 2026-06-10 |
| Фаза | Фаза 0 — Предварительный ресёрч и инфраструктура |
