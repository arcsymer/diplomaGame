...
| Поле | Значение |
|---|---|
| Релиз | v1.13.0 (фаза улучшения, круг 13) |
| Фаза | Улучшение (v3): Measure → Benchmark → … → Commit |
| Круг 13 | Уровни сложности ИИ — DifficultyProfileSO + выбор в меню (ADR-032) |
| Круги 1–12 | Отчёты в [[Improvements/00 - Backlog|Improvements/]] — от способностей героя до game feel |
| Следующий шаг | Backlog: мониторинг винрейта зеркала ([[Improvements/00 - Backlog]]) |
| Гэп-анализ | [[Improvements/01 - Гэп-анализ v1.0.0 (промпты vs реализация)]] |
| Метрики улучшения | [[Improvements/Metrics]] (накопительно) |
| Веб-версия | https://arcsymer.github.io/diplomaGame/ |
...
- [[04 - Decision Log]] — Журнал ADR (ADR-001..032)
