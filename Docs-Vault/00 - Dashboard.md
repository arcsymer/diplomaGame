...
| Поле | Значение |
|---|---|
| Релиз | v1.1.0 (фаза улучшения, круг 1) |
| Фаза | Улучшение (v3): Measure → Benchmark → … → Commit |
| Круг 1 | Гэп-анализ → харнессы → способности героя 2–4 (ADR-013/014) |
| Следующий шаг | P1 backlog: тултипы HUD ([[Improvements/00 - Backlog]]) |
